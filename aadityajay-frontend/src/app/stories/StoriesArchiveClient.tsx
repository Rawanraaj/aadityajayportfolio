...
import { categories, Article } from "@/data/articles";
...
export default function StoriesArchiveClient({ articles }: StoriesArchiveClientProps) {
      ...
      <header className="grain-overlay relative border-b border-paper-50/10 bg-ink-900 px-6 pb-12 pt-32 md:px-10 md:pb-16 md:pt-40">
        <div className="mx-auto max-w-editorial">
          ...
          <p className="mt-4 max-w-lg text-sm leading-relaxed text-paper-50/60">
            {articles.length} selected stories across investigation, politics, society, and
